...
- Use the USB micro-AB port J4 which is located on the bottom side of the [PIC32MX 1/2/5 Starter Kit](https://www.microchip.com/Developmenttools/ProductDetails/dm320100) to connect the USB Device to the USB Host PC
