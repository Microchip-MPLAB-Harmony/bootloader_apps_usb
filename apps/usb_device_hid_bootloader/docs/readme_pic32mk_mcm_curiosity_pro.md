...
9. Configure the Unified host application
    ...
    - Load the test application hex file to be programmed using below option
        - *\<harmony3_path\>\bootloader_apps_usb\apps\usb_device_hid_bootloader\test_app\firmware\pic32mk_mcm_curiosity_pro.X\dist\pic32mk_mcm_curiosity_pro\production\pic32mk_mcm_curiosity_pro.X.production.hex*
