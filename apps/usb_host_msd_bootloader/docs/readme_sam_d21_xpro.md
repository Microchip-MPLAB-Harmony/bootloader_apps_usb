...
8. Copy the generated application binary file to a USB Flash drive from the Host PC
    - *\<harmony3_path\>\bootloader_apps_usb\apps\usb_host_msd_bootloader\test_app\firmware\sam_d21_xpro.X\dist\sam_d21_xpro\production\sam_d21_xpro.X.production.bin*
