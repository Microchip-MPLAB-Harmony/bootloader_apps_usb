...
|------------|-----------|
|bootloader/firmware/sam\_l21\_xpro.X|MPLABX Project for [SAM L21 Xplained Pro Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/ATSAML21-XPRO-B)|

### Test Application

|Project Name|Description|
|------------|-----------|
|test\_app/firmware/sam\_l21\_xpro.X|MPLABX Project for [SAM L21 Xplained Pro Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/ATSAML21-XPRO-B)|
...
1.  Open the test application project *test\_app/firmware/sam\_l21\_xpro.X* in the IDE

2.  Build the project to generate the binary **\(Do not program the binary\)**

3.  Open the bootloader project *bootloader/firmware/sam\_l21\_xpro.X* in the IDE
...
9.  Configure the Unified host application
    ...
    -   Load the test application hex file to be programmed using below option
        ...
        -   *<harmony3\_path\>/bootloader\_apps\_usb/apps/usb\_device\_hid\_bootloader/test\_app/firmware/sam\_l21\_xpro.X/dist/sam\_l21\_xpro/production/sam\_l21\_xpro.X.production.hex*
