# SAM E70 Xplained Ultra Evaluation Kit: Building and Running the USB Device HID Bootloader applications
...
9.  Configure the Unified host application
    ...
    -   Load the test application hex file to be programmed using below option
        ...
        -   *<harmony3\_path\>/bootloader\_apps\_usb/apps/usb\_device\_hid\_bootloader/test\_app/firmware/sam\_e70\_xult.X/dist/sam\_e70\_xult/production/sam\_e70\_xult.X.production.hex*
