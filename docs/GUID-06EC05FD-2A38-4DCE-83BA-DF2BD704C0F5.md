# SAM E70 Xplained Ultra Evaluation Kit: Building and Running the USB Host MSD Bootloader applications
...
-   Use TARGET USB J202 connector on the board to connect the USB Device to the USB Host
...
8.  Copy the generated application binary file to a USB Flash drive from the Host PC
    ...
    -   *<harmony3\_path\>\\bootloader\_apps\_usb\\apps\\usb\_host\_msd\_bootloader\\test\_app\\firmware\\sam\_e70\_xult.X\\dist\\sam\_e70\_xult\\production\\sam\_e70\_xult.X.production.bin*
