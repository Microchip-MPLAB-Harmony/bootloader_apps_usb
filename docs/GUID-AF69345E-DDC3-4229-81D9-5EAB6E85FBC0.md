...
9.  Configure the Unified host application
    ...
    -   Load the test application hex file to be programmed using below option
        ...
        -   *<harmony3\_path\>/bootloader\_apps\_usb/apps/usb\_device\_hid\_bootloader/test\_app/firmware/sam\_d21\_xpro.X/dist/sam\_d21\_xpro/production/sam\_d21\_xpro.X.production.hex*
